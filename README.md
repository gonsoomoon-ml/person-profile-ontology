...
- 🎯 **개인화 추천** — 행동 기반 취향 + 동네 맞춤, 가본 곳 제외 → **재주문·전환 ↑**
- 🛡️ **안전·규정 준수 추천** — 채식·비건 등 식이 제한 위반 메뉴 자동 제외
- 💬 **설명 가능한 추천(why)** — 추천 이유를 함께 제시 → **신뢰 ↑**
- 👤 **고객 이해·세분화** — 프로파일 카드(최애 요리·RFM·지출), 고가치 고객·자동 페르소나
- 📣 **룩어라이크 확장** · 🆕 **신규 고객 콜드스타트** · 🧺 **크로스셀·번들**

**주목할 신호(데모 hero 장면):** *"말한 것(stated) vs 실제 행동(revealed)"* 의 차이 — 선언 취향과 주문이 드러낸 취향의 간극. (예: "이탈리안 좋아해"라 했지만 실제론 매번 멕시칸.) 단, 이는 유용한 프로파일 신호 하나일 뿐, 시스템의 핵심은 **3-tier 구조**(↓ "핵심 개념")다.
